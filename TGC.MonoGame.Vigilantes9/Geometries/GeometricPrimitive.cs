...
namespace TGC.MonoGame.Vigilantes9.Geometries
{
    /// <summary>
    ...
    public abstract class GeometricPrimitive : IDisposable
    {
        ...
        public List<IVertexType> Vertices { get; } = new List<IVertexType>();
        ...
        ///     InitializePrimitive.
        /// </summary>
        protected void AddVertex(IVertexType vertex)
        {
            Vertices.Add(vertex);
        }
        ...
        /// </summary>
        protected void InitializePrimitive<T>(GraphicsDevice graphicsDevice) where T : struct, IVertexType
        {
            // Create a vertex declaration, describing the format of our vertex data.

            // Create a vertex buffer, and copy our vertex data into it.
            VertexBuffer = new VertexBuffer(graphicsDevice, typeof(T), Vertices.Count,
                BufferUsage.None);
            VertexBuffer.SetData<T>(Array.ConvertAll(Vertices.ToArray(), item => (T)item));
