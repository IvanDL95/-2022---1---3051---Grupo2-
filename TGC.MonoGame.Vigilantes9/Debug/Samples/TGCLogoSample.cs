...
namespace TGC.MonoGame.Vigilantes9.Debug.Samples
{
    /// <summary>
    ...
    public class TGCLogoSample : TGCSample
    {
        ...
        public TGCLogoSample(TGCDebug game) : base(game)
        {
            Name = GetType().Name;
        ...
        {
            Camera = new StaticCamera(GraphicsDevice.Viewport.AspectRatio, Vector3.UnitZ * 150, Vector3.UnitZ);
